...
/* harmony import */ var _modules_userManagement_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/userManagement.mjs */ "./src/js/modules/userManagement.mjs");
/* harmony import */ var _modules_deviceMotion_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/deviceMotion.mjs */ "./src/js/modules/deviceMotion.mjs");
/* harmony import */ var _modules_deviceIdentification_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/deviceIdentification.mjs */ "./src/js/modules/deviceIdentification.mjs");
/* harmony import */ var _modules_animation_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/animation.mjs */ "./src/js/modules/animation.mjs");
/* harmony import */ var _modules_utils_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/utils.mjs */ "./src/js/modules/utils.mjs");
...
var debug = true;
var deviceType = _modules_utils_mjs__WEBPACK_IMPORTED_MODULE_5__["detectDeviceType"]();
...
var userManagement = new _modules_userManagement_mjs__WEBPACK_IMPORTED_MODULE_1__["default"](socket, debug);
var deviceMotion = new _modules_deviceMotion_mjs__WEBPACK_IMPORTED_MODULE_2__["default"]();
var deviceIdentification = new _modules_deviceIdentification_mjs__WEBPACK_IMPORTED_MODULE_3__["default"](socket, debug);
var playground = document.querySelector('#playground');
var animation = new _modules_animation_mjs__WEBPACK_IMPORTED_MODULE_4__["default"](playground);
userManagement.initListeners(); // deviceMotion.initListeners();

deviceIdentification.initListeners();

/***/ }),

/***/ "./src/js/modules/animation.mjs":
/*!**************************************!*\
  !*** ./src/js/modules/animation.mjs ***!
  \**************************************/
...
/* harmony import */ var _ball_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ball.mjs */ "./src/js/modules/ball.mjs");
...
var Animation = /*#__PURE__*/function () {
  ...
  _createClass(Animation, [{
    ...
    value: function init() {
      this.addBall();
      this.initListeners();
      this.balls.get(0).triggerAnimation(); // window.requestAnimationFrame(this.balls.get(0).animate.bind(this.balls.get(0)));
    }
  }, {
    key: "addBall",
    value: function addBall() {
      var ball = new _ball_mjs__WEBPACK_IMPORTED_MODULE_0__["default"](40);
...
var Ball = /*#__PURE__*/function () {
  function Ball(radius) {
    ...
    this.radius = radius; // position from top left
  ...
  _createClass(Ball, [{
    key: "addToPlayground",
    value: function addToPlayground(playground) {
      this.playground = playground;
      this.ballElement = document.createElement('div');
      this.ballElement.classList.add('ball');
      this.ballElement.style.width = "".concat(this.radius * 2, "px");
      this.ballElement.style.height = "".concat(this.radius * 2, "px");
      this.playground.appendChild(this.ballElement);
    }
  }, {
    key: "centerBall",
    value: function centerBall() {}
  }, {
    key: "animate",
    value: function animate(timestamp) {
      ...
      var x = progress / 10;
      var y = progress / 10;
      this.ballElement.style.transform = "translate3d(".concat(x, "px, ").concat(y, "px, 0)");
...
/***/ "./src/js/modules/deviceIdentification.mjs":
/*!*************************************************!*\
  !*** ./src/js/modules/deviceIdentification.mjs ***!
  \*************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return DeviceIdentification; });
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var DeviceIdentification = /*#__PURE__*/function () {
  function DeviceIdentification(socket, debug) {
    _classCallCheck(this, DeviceIdentification);

    this.socket = socket;
    this.debug = debug;
    this.animationEffects = ['blurEffect'];
  }

  _createClass(DeviceIdentification, [{
    key: "identifyDevice",
    value: function identifyDevice(data) {
      var _this = this;

      console.log('Ping from ' + data.triggerSocketId);
      console.log("myOrder is ".concat(data.userPosition));
      var delayToStartAnimation = 0;
      var animationInDuration = 1000;
      var animationStopDuration = 500;
      var animationOutDuration = 1000;

      if (data.userPosition == 1) {
        delayToStartAnimation = 500;
      }

      var animationClassIndex = Math.floor(this.animationEffects.length * Math.random());
      var identifyContainer = document.querySelector('.identifyContainer');
      var identifyWrapper = document.querySelector('.identifyWrapper');
      identifyWrapper.classList.add(this.animationEffects[animationClassIndex]); // force layout reflow, see: https://gist.github.com/paulirish/5d52fb081b3570c81e3a
      ...
      setTimeout(function () {
        ...
        identifyWrapper.classList.remove(_this.animationEffects[animationClassIndex]);
        identifyContainer.classList.remove('identifyOut');

        _this.socket.emit('identifyDeviceReply');

        console.log('event sent');
      }, delayToStartAnimation + animationInDuration + animationStopDuration + animationOutDuration);
    }
  }, {
    key: "identifyDevicesTriggered",
    value: function identifyDevicesTriggered() {
      document.querySelector('html').classList.add('deviceIdentificationTriggered');
    }
  }, {
    key: "identifyDevicesFinished",
    value: function identifyDevicesFinished() {
    ...
    value: function initListeners() {
      ...
      var identifyBtn = document.querySelector('#identifyDevices');
      identifyBtn.addEventListener('click', function () {
        console.log('start');

        _this2.socket.emit('identifyDevicesStartTrigger');
      });
...
/***/ "./src/js/modules/deviceMotion.mjs":
/*!*****************************************!*\
  !*** ./src/js/modules/deviceMotion.mjs ***!
  \*****************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return DeviceMotion; });
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var DeviceMotion = /*#__PURE__*/function () {
  ...
  _createClass(DeviceMotion, [{
    ...
    value: function handleOrientation(event) {
      ...
      console.log(event);
      document.querySelector('#data').innerHTML = "absolute: ".concat(event.absolute, "<br>\n    alpha: ").concat(Math.round((event.alpha + Number.EPSILON) * 10000) / 10000, "<br>\n    beta : ").concat(Math.round((event.beta + Number.EPSILON) * 10000) / 10000, "<br>\n    gamma: ").concat(Math.round((event.gamma + Number.EPSILON) * 10000) / 10000, "<br>");
    }
  }, {
    key: "initListeners",
    value: function initListeners() {
      if (typeof DeviceMotionEvent.requestPermission === 'function') {
        var permissionButton = document.querySelector('#enableMotionTracking');
...
var User = /*#__PURE__*/function () {
  function User(id, numberId, color, deviceType, isCurrentClient) {
  ...
  _createClass(User, [{
    key: "randomDeviceIcon",
    value: function randomDeviceIcon() {
      var keys = Object.keys(this.deviceIcons);
      return this.deviceIcons[keys[keys.length * Math.random() << 0]];
    }
  }, {
    key: "createUserElement",
    value: function createUserElement(animated) {
      var _this = this;

      var userNode = document.createElement('article');
      ...
      var deviceIcon = this.randomDeviceIcon();
      var userHtml = "\n      <div class=\"userHeader\">  \n        <img class=\"deviceIcon replaceWithInlineSVG\" draggable=\"false\" src=\"/static/icons/".concat(this.deviceType, ".svg\">\n        <div class=\"userColorDot\" style=\"background:").concat(this.color, "\"></div>\n      </div>\n      <p class=\"userName\" style=\"border-color:").concat(this.color, ";\">User ").concat(this.numberId, "</p>");
      userNode.innerHTML = userHtml;
      document.querySelector(this.userElementsContainer).appendChild(userNode);

      if (animated) {
        setTimeout(function () {
          document.getElementById(_this.socketId).classList.add('show');
        }, 500);
      }

      inline_svg__WEBPACK_IMPORTED_MODULE_0__.init({
        svgSelector: '.replaceWithInlineSVG',
    ...
    key: "removeUserDOMElement",
    value: function removeUserDOMElement() {
      var elem = document.getElementById("".concat(this.socketId)); // document.querySelector(`#${this.socketId}`); ist not valid
      // if id starts with a number/digit, querySelector produces an error

      if (elem) {
        elem.remove();
      } else {
        console.warn("element to remove not found: ".concat(this.socketId));
      }
    }
    /**
...
/***/ "./src/js/modules/userManagement.mjs":
/*!*******************************************!*\
  !*** ./src/js/modules/userManagement.mjs ***!
  \*******************************************/
/*! exports provided: default */
...
/* harmony import */ var _user_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./user.mjs */ "./src/js/modules/user.mjs");
...
var UserManagement = /*#__PURE__*/function () {
  function UserManagement(socket, debug) {
  ...
  _createClass(UserManagement, [{
    key: "userConnectUpdate",
    value: function userConnectUpdate(data) {
      var isCurrentClient = false; // add new logged in user to dom and localRegistredUsers

      if (this.socket.id === data.newConnectedUser.socketId) {
        isCurrentClient = true;
      }

      var newUser = new _user_mjs__WEBPACK_IMPORTED_MODULE_0__["default"](data.newConnectedUser.socketId, data.newConnectedUser.numberId, data.newConnectedUser.color, data.newConnectedUser.deviceType, isCurrentClient);
      ...
      var connectedUsers = new Map(JSON.parse(data.connectedUsersArray));
      ...
      if (connectedUsers.size > 1) {
        // this.localRegistredUsers.size
        var _iteratorNormalCompletion = true;
        var _didIteratorError = false;
        var _iteratorError = undefined;

        try {
          for (var _iterator = connectedUsers[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            var _step$value = _slicedToArray(_step.value, 2),
                key = _step$value[0],
                value = _step$value[1];

            if (!this.localRegistredUsers.has(key)) {
              var prevUser = new _user_mjs__WEBPACK_IMPORTED_MODULE_0__["default"](value.socketId, // key
              value.numberId, value.color, value.deviceType, false); // prevUser.createUserElement();

              prevUser.addToMap(this.localRegistredUsers);
              prevUser.addToMap(this.userBuffer); // this.userBuffer.set(prevUser.order, prevUser);

              if (this.debug) {
                console.groupCollapsed("added previous user ".concat(key));
                console.log(prevUser);
                console.log("this.localRegistredUsers.size = ".concat(this.localRegistredUsers.size));
                console.groupEnd();
              }
            }
          }
      ...
      if (this.localRegistredUsers.size > connectedUsers.size) {
        if (this.debug) {
          ...
          console.log("connectedUsers.size = ".concat(connectedUsers.size));
          console.log(connectedUsers);
          console.log(this.localRegistredUsers);
          console.groupEnd();
        }
        ...
        try {
          for (var _iterator2 = this.localRegistredUsers[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
            var _step2$value = _slicedToArray(_step2.value, 2),
                _key = _step2$value[0],
                _value = _step2$value[1];

            if (!connectedUsers.has(_key)) {
              this.deleteUser(_key);
              console.log("removed user ".concat(_key, " because of disconnection"));
            }
          }
        } catch (err) {
    ...
    value: function printDevices() {
      ...
      this.userOrder.forEach(function (value, index) {
        // append just buffered ones
        if (_this.userBuffer.has(value)) {
          var animated = false; // animate last insert

          if (index === _this.userOrder.length - 1) {
            animated = true;
          }

          var user = _this.localRegistredUsers.get(value);

          user.createUserElement(animated);

          if (_this.debug) {
            console.log("id (value) = ".concat(value));
            console.log("index (wie order) = ".concat(index));
            console.log("this.userOrder.length = ".concat(_this.userOrder.length));
            console.log(user);
          }
        }
      });
    ...
    key: "printDevicesAfterReorder",
    value: function printDevicesAfterReorder() {
      var _this2 = this;

      this.userOrder.forEach(function (value, index) {
        var user = _this2.localRegistredUsers.get(value);
    ...
    key: "userDisconnectUpdate",
    value: function userDisconnectUpdate(data) {
      this.userOrder = data.userOrder;
      this.deleteUser(data.deletedUser.socketId);
    }
  }, {
    key: "deleteUser",
    value: function deleteUser(socketId) {
      var user = this.localRegistredUsers.get(socketId);
      user.removeUserDOMElement();
      user.removeFromMap(this.localRegistredUsers);
    }
  }, {
    key: "orderUpdate",
    value: function orderUpdate(newOrder) {
      var _this3 = this;

      this.userOrder = newOrder;
      var connectedDevices = document.querySelector(this.connectedDevicesDomSelector);
      connectedDevices.classList.add('reordering'); // remove dom-element after hide animation

      setTimeout(function () {
        var userElements = document.querySelectorAll(_this3.deviceDomElementSelector);
        Array.from(userElements).forEach(function (userElement) {
          userElement.remove();

          if (_this3.debug) {
            console.groupCollapsed("removed ".concat(userElement.id, " from dom because of reordering"));
            console.log(userElement);
            console.groupEnd();
          }
        });

        _this3.printDevicesAfterReorder();
    ...
    value: function onDragStart(e) {
      ...
      var userElement = e.currentTarget;
      userElement.classList.add('dragging'); // e.dataTransfer.setData("text/plain", e.currentTarget.id);
      // must define on dragstart

      e.dataTransfer.effectAllowed = 'move'; // e.dataTransfer.setData('text/html', userElement.outerHTML);
    ...
    value: function onDragEnd(e) {
      ...
      var userElements = document.querySelectorAll(this.deviceDomElementSelector);
      Array.from(userElements).forEach(function (userElement) {
        userElement.classList.remove('draggingOver');
      });
      var dragOverContainer = document.querySelector(this.connectedDevicesDomSelector);
      dragOverContainer.classList.remove('draggingOver');
    }
  }, {
    key: "onDragOverConnectedDevices",
    value: function onDragOverConnectedDevices(e) {
      e.preventDefault();
      var dragOverContainer = e.currentTarget;
      dragOverContainer.classList.add('draggingOver');
    }
  }, {
    key: "onDragLeaveConnectedDevices",
    value: function onDragLeaveConnectedDevices(e) {
      var dragOverContainer = e.currentTarget;
      dragOverContainer.classList.remove('draggingOver');
    }
  }, {
    key: "onDropOverConnectedDevices",
    value: function onDropOverConnectedDevices(e) {
      e.preventDefault();
      e.dataTransfer.dropEffect = 'move'; // const transferredHTML = e.dataTransfer.getData('text/html');
      ...
      } while (targetElement); // this inserts the source element after the target element
      ...
      var dragOverContainer = document.querySelector(this.connectedDevicesDomSelector);
      var newOrder = [];
      dragOverContainer.childNodes.forEach(function (userDevice) {
    ...
    key: "onDragEnterUserElement",
    value: function onDragEnterUserElement(e) {
      var userElement = e.currentTarget;
      userElement.classList.add('draggingOver');
    }
  }, {
    key: "onDragLeaveUserElement",
    value: function onDragLeaveUserElement(e) {
      var userElement = e.currentTarget;
      userElement.classList.remove('draggingOver');
    }
  }, {
    key: "initUserElementListeners",
    value: function initUserElementListeners() {
      var _this4 = this;

      var userElements = document.querySelectorAll(this.deviceDomElementSelector);
      Array.from(userElements).forEach(function (userElement) {
        userElement.addEventListener('dragstart', _this4.onDragStart.bind(_this4));
        userElement.addEventListener('dragend', _this4.onDragEnd.bind(_this4));
        userElement.addEventListener('dragover', _this4.onDragEnterUserElement.bind(_this4));
        userElement.addEventListener('dragleave', _this4.onDragLeaveUserElement.bind(_this4));
      });
    }
  }, {
    key: "initListeners",
...
/***/ "./src/js/modules/utils.mjs":
/*!**********************************!*\
  !*** ./src/js/modules/utils.mjs ***!
  \**********************************/
/*! exports provided: getRandomColor, isIos, isTochDevice, detectDeviceType, removeElementFromArray */
/***/ (function(__webpack_module__, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isTochDevice", function() { return isTochDevice; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "detectDeviceType", function() { return detectDeviceType; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "removeElementFromArray", function() { return removeElementFromArray; });
...
var isTochDevice = function isTochDevice() {
